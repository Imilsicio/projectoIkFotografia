...
$sql = "SELECT * FROM cliente inner join usuario  on usuario.id=cliente.idcliente where evento='outros' ";
$statement = $connection->prepare($sql);
$statement->execute();
$cliente = $statement->fetchAll(PDO::FETCH_OBJ);


$sql = "SELECT COUNT(*) FROM cliente where status ='pendente' and evento='outros'";
$statement = $connection->prepare($sql);
$statement->execute();
$countPendente = $statement->fetchColumn();

$sql = "SELECT COUNT(*) FROM cliente where status ='activo' and evento='outros'";
$statement = $connection->prepare($sql);
$statement->execute();
$countActivo = $statement->fetchColumn();

$sql = "SELECT COUNT(*) FROM cliente where status ='feito' and evento='outros'";
$statement = $connection->prepare($sql);
$statement->execute();
$countfeito = $statement->fetchColumn();

$sql = "SELECT COUNT(*) FROM cliente where evento='outros'";
$statement = $connection->prepare($sql);
$statement->execute();
...
<body>
    ...
    <?php elseif ($adm == 2) : ?>
        ...
        $sql = "SELECT * FROM cliente c inner join usuario u on c.idcliente=u.id WHERE evento='outro'and fotografo='$usuario[1]'";
        ...
        $sql = "SELECT COUNT(*) FROM cliente where status ='activo' and fotografo='$usuario[1]' and evento='outro'";
        $statement = $connection->prepare($sql);
        $statement->execute();
        $countActivo = $statement->fetchColumn();

        $sql = "SELECT COUNT(*) FROM cliente where status ='pendente' and fotografo='$usuario[1]' and evento='outro'";
        $statement = $connection->prepare($sql);
        $statement->execute();
        $countPendente = $statement->fetchColumn();

        $sql = "SELECT COUNT(*) FROM cliente where status ='feito' and fotografo='$usuario[1]' and evento='outro'";
        $statement = $connection->prepare($sql);
        $statement->execute();
        $countfeito = $statement->fetchColumn();

        $sql = "SELECT COUNT(*) FROM cliente where  fotografo='$usuario[1]' and evento='outro'";
        $statement = $connection->prepare($sql);
        $statement->execute();
        $countCliente = $statement->fetchColumn();
