                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="pageSubmenu">
                            ...
                            <li>
                                <a href="criarCliente.php">cliente</a>
                            </li>
                            <li>
                                <a href="#">Estudio</a>
                            </li>
                                        ...
                                        <div class="card-body">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="validationTextarea" name="texto" aria-describedby="validationServer03Feedback" required>
